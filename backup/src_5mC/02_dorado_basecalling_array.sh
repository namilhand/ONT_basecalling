...
#SBATCH --mem=200G
#SBATCH --array=1-209%1  # Replace N with number of chunks, %1 means process one at a time
...
#    python split_pod5.py SAM-seq5.pod5 -r 1000000 -o pod5_chunks
#
...
# Configuration
WORK_DIR="/home/ns2040/rds/rds-pollen-7KhEnGLnebA/namil/data/20250620_R10_f1leaf"
POD5_CHUNKS_DIR="${WORK_DIR}/pod5"
OUTPUT_DIR="${WORK_DIR}/bam"
...
OUTPUT_BAM="${OUTPUT_DIR}/${CHUNK_BASENAME}_sup_5mc_5hmc.bam"
